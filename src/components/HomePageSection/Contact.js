                ...
                <form>
                    <div className='grid lg:grid-cols-2 lg:p-20 p-10'>
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Your name" className=" w-full border p-3 lg:mr-5 rounded" />

                        </div>
                        <div>
                            <label htmlFor="name" className='lg:ml5'>Your Email</label><br />
                            <input type="text" placeholder="Your Email" className=" w-full border p-3 lg:ml5 rounded" />

                        </div>
                        <div>
                            <label htmlFor="name" className='lg:mr-5'>Your Address</label><br />
                            <input type="text" placeholder="Your Address" className=" w-full border p-3 lg:mr-5 rounded" />

                        </div>
                        <div>
                            <label htmlFor="name" className='lg:ml5'>Your Subject</label><br />
                            <input type="text" placeholder="Your name" className=" w-full border p-3 lg:ml5 rounded" />

                        </div>

                    </div>
                    <div className='lg:px-20 px-10 pb-10 mt-[-30px] lg:mt-[-60px]'>
                        <textarea type="textarea" placeholder="Write Comments " className=" w-full border  rounded" />
